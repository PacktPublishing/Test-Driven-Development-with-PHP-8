 ...
 */
final class Version20221002001727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE toy_car (id INT AUTO_INCREMENT NOT NULL, manufacturer_id INT DEFAULT NULL, color_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, year DATE DEFAULT NULL, INDEX IDX_9339340CA23B42D (manufacturer_id), INDEX IDX_9339340C7ADA1FB5 (color_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
